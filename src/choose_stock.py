...
def GetChampionStock(op):
    ...
    if op == 3:
        basicStockInfo_df = GetBasicStockInfo()
        sum_df = pd.DataFrame()
        for stockId in ['6257']: #['1229', '1231', '1409', '1474', '1514', '1515', '1587', '2020', '2069', '2324', '2347', '2352', '2385', '2417', '2458', '2520', '2546', '2881', '3005', '3044', '3209', '3706', '5515', '6257' '8112', '8150', '8213', '9945']:
